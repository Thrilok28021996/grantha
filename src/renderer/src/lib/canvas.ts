 ...
 * Grantha canvas opens in Obsidian and vice-versa — the vault stays interoperable rather
 * than locked into a Grantha-only shape. This module is pure (no React, no I/O) so the
...
export const NOTE_DND_MIME = 'application/x-grantha-note'
