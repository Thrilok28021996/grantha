...
export function Settings({ onClose }: { onClose: () => void }): React.JSX.Element {
  ...
  const runUpdateCheck = async (): Promise<void> => {
    setChecking(true)
    try {
      setUpdateInfo((await window.grantha.checkUpdates()) ?? false)
    } finally {
      setChecking(false)
    }
  }
      ...
      <div className="modal settings-modal" onMouseDown={(e) => e.stopPropagation()}>
        ...
        <div className="settings-section">
          ...
          <div className="settings-hint">
            Pick any folder of Markdown notes. Grantha reads and writes plain <code>.md</code> files —
        ...
        <div className="settings-section">
          ...
          <div className="settings-hint">
            When you paste a bare URL, Grantha fetches that page once to turn it into a titled
        ...
        <div className="settings-section">
          ...
          <div className="settings-hint">
            One request to GitHub, only when you click — Grantha never checks automatically.
          </div>
        </div>
        </div>
      </div>
